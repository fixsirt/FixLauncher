...
1. Скачай файл `FixLauncher-Setup.exe`
...
### 🪟 Запуск без лишних окон
- Запускай через `launch.bat` — **никакого чёрного консольного окна** на экране
...
Пиши в раздел **Issues** — не молчи, вместе сделаем лаунчер лучше! 🙏
